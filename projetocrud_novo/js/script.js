...
function alterar(cpf){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        if (cliente.cpf == cpf){
            ...
            document.getElementById("apelidoInfancia").value = cliente.apelidoInfancia
...
function excluir(cpf){
    if (confirm("Você deseja realmente excluir?")){
        fetch("http://localhost:3000/excluir/" + cpf, {
            ...
            //exclui e logo após recarrega a lista
            recarregarClientes
...
function salvar(){
    ...
    let apelidoInfancia = document.getElementById("apelidoInfancia").value
    ...
    if (clienteAlterado == null){
        let cliente = {
            ...
            "apelidoInfancia": apelidoInfancia
        }
        fetch("http://localhost:3000/cadastrar", {
            ...
            alert("Cliente cadastrado cm sucesso")
        }).catch(() => {
            alert("ops...")
        })
        ...
        clienteAlterado.apelidoInfancia = apelidoInfancia
...
function exibirDados(){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        <tr>
            ...
            <td>${clientes[i].apelidoInfancia}</td>
            <td>
...
function limparForm(){
    ...
    document.getElementById("apelidoInfancia").value = ""
}
